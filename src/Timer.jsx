...
const TimerItem = ({ idx, elm, selected }) => {
    ...
    return (
        ...
        <form className={!selected ? timerStyles.timerListItem : timerStyles.timerListItem + ' ' + timerStyles.timerItemSel} onClick={click} onSubmit={formSubmit}>
            <TimerHeader elm={elm} />
...
export const TimerList = () => {
    ...
    const timersElements = useMemo(() => {
        return timers.map((el, idx) => {
            return (
                <TimerItem key={idx} idx={idx} elm={el} selected={currSelElmIdx === idx} />
            )
        });
